...
public abstract class LightUpSpesification {
  ...
  public static void main(String[] args) {
    ...
    final ITerm test2 = ITerm.let("test2", LightUpSpesification.mkLightUp(LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._B(), LightUpSpesification._1(), LightUpSpesification._W()), LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._X(), LightUpSpesification._1(), LightUpSpesification._B()), LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._B(), LightUpSpesification._2(), LightUpSpesification._W()), LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._B(), LightUpSpesification._W()), LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._B(), LightUpSpesification._1(), LightUpSpesification._W(), LightUpSpesification._W())));
