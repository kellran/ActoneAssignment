...
public abstract class LightUpSpesification {
  ...
  private static final Operator oper_CountWhiteAroundNumbers = new Operator(false, "CountWhiteAroundNumbers");
  ...
  private static final Operator oper_SwitchLine = new Operator(false, "SwitchLine");
  ...
  public static Int CountWhite(Box Box_11) {
    return new Int(oper_CountWhite, Box_11);
  }
  public static Bool CountWhiteAroundNumbers(AdjecentBlock AdjecentBlock_5) {
    return new Bool(oper_CountWhiteAroundNumbers, AdjecentBlock_5);
  }
  public static Int CountNumberedBox(Box Box_12) {
    return new Int(oper_CountNumberedBox, Box_12);
  }
  public static Bool CountBulbsAroundNumber(AdjecentBlock AdjecentBlock_6) {
    return new Bool(oper_CountBulbsAroundNumber, AdjecentBlock_6);
  }
  ...
  public static Line SwitchLine(Line Line_8) {
    return new Line(oper_SwitchLine, Line_8);
  }
  public static Bool FindLights(Box Box_16) {
    return new Bool(oper_FindLights, Box_16);
  }
  public static LightUp CheckAdjacentBoxesForLight(LightUp LightUp_4) {
    return new LightUp(oper_CheckAdjacentBoxesForLight, LightUp_4);
  }
  public static LightUp PutLights(LightUp LightUp_5) {
    return new LightUp(oper_PutLights, LightUp_5);
  }
  public static Bool CorrectPuzzle(LightUp LightUp_6) {
    return new Bool(oper_CorrectPuzzle, LightUp_6);
  }
  public static LightUp Transpose(LightUp LightUp_7) {
    return new LightUp(oper_Transpose, LightUp_7);
  }
  ...
  /*package*/ static void initAxioms() {
    ...
    ITerm.axiom(LightUpSpesification.SwitchLine(LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.T5)), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T1, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)))))), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T1, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)))))), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T1, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)))))), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.Switch(LightUpSpesification.T5)), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.Switch(LightUpSpesification.T5)), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.Switch(LightUpSpesification.T5)), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T1, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.Switch(LightUpSpesification.T5)), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.Switch(LightUpSpesification.T5)))))), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T1, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5))))), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.T5)))))));
    ITerm.axiom(LightUpSpesification.SwitchLine(LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.T5)), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T1, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)))))), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T1, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)))))), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T1, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.Switch(LightUpSpesification.T5)))))), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T1, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.Switch(LightUpSpesification.T5)), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.T4, LightUpSpesification.Switch(LightUpSpesification.T5)))))), BOOLEAN.If_Then_Else(BOOLEAN.Equal(LightUpSpesification.T5, LightUpSpesification._B()), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T4, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T3, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.T2, LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), BOOLEAN.If_Then_Else(BOOLEAN.Not(BOOLEAN.Equal(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification._W())), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5), LightUpSpesification.mkLine(LightUpSpesification.Switch(LightUpSpesification.T1), LightUpSpesification.Switch(LightUpSpesification.T2), LightUpSpesification.Switch(LightUpSpesification.T3), LightUpSpesification.Switch(LightUpSpesification.T4), LightUpSpesification.T5))))), LightUpSpesification.mkLine(LightUpSpesification.T1, LightUpSpesification.T2, LightUpSpesification.T3, LightUpSpesification.T4, LightUpSpesification.T5)))))));
    ITerm.axiom(LightUpSpesification.PutLights(LightUpSpesification.mkLightUp(LightUpSpesification.mkLine(LightUpSpesification.B1_1, LightUpSpesification.B1_2, LightUpSpesification.B1_3, LightUpSpesification.B1_4, LightUpSpesification.B1_5), LightUpSpesification.mkLine(LightUpSpesification.B2_1, LightUpSpesification.B2_2, LightUpSpesification.B2_3, LightUpSpesification.B2_4, LightUpSpesification.B2_5), LightUpSpesification.mkLine(LightUpSpesification.B3_1, LightUpSpesification.B3_2, LightUpSpesification.B3_3, LightUpSpesification.B3_4, LightUpSpesification.B3_5), LightUpSpesification.mkLine(LightUpSpesification.B4_1, LightUpSpesification.B4_2, LightUpSpesification.B4_3, LightUpSpesification.B4_4, LightUpSpesification.B4_5), LightUpSpesification.mkLine(LightUpSpesification.B5_1, LightUpSpesification.B5_2, LightUpSpesification.B5_3, LightUpSpesification.B5_4, LightUpSpesification.B5_5))), LightUpSpesification.mkLightUp(LightUpSpesification.SwitchLine(LightUpSpesification.mkLine(LightUpSpesification.B1_1, LightUpSpesification.B1_2, LightUpSpesification.B1_3, LightUpSpesification.B1_4, LightUpSpesification.B1_5)), LightUpSpesification.SwitchLine(LightUpSpesification.mkLine(LightUpSpesification.B2_1, LightUpSpesification.B2_2, LightUpSpesification.B2_3, LightUpSpesification.B2_4, LightUpSpesification.B2_5)), LightUpSpesification.SwitchLine(LightUpSpesification.mkLine(LightUpSpesification.B3_1, LightUpSpesification.B3_2, LightUpSpesification.B3_3, LightUpSpesification.B3_4, LightUpSpesification.B3_5)), LightUpSpesification.SwitchLine(LightUpSpesification.mkLine(LightUpSpesification.B4_1, LightUpSpesification.B4_2, LightUpSpesification.B4_3, LightUpSpesification.B4_4, LightUpSpesification.B4_5)), LightUpSpesification.SwitchLine(LightUpSpesification.mkLine(LightUpSpesification.B5_1, LightUpSpesification.B5_2, LightUpSpesification.B5_3, LightUpSpesification.B5_4, LightUpSpesification.B5_5))));
  ...
  public static void main(String[] args) {
    ...
    final ITerm test1 = ITerm.let("test1", LightUpSpesification.mkLightUp(LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._B(), LightUpSpesification._2(), LightUpSpesification._W(), LightUpSpesification._W()), LightUpSpesification.mkLine(LightUpSpesification._B(), LightUpSpesification._W(), LightUpSpesification._B(), LightUpSpesification._3(), LightUpSpesification._B()), LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._2(), LightUpSpesification._B(), LightUpSpesification._W()), LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._B(), LightUpSpesification._W(), LightUpSpesification._W()), LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._W())));

    Reductions.initReduction(Reductions.Traversal.DFS, false, LightUpSpesification.CountBulbsInPuzzle((LightUp) test1));
    Reductions.initReduction(Reductions.Traversal.DFS, false, LightUpSpesification.PutLights((LightUp) test1));
    Reductions.initReduction(Reductions.Traversal.DFS, false, LightUpSpesification.PutLights(LightUpSpesification.Transpose((LightUp) test1)));
  }
