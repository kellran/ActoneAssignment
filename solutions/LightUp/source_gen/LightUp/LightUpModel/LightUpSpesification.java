...
public abstract class LightUpSpesification {
  ...
  public static Bool CorrectPuzzle(LightUp LightUp_5) {
    return new Bool(oper_CorrectPuzzle, LightUp_5);
  }
  public static LightUp Transpose(LightUp LightUp_6) {
    return new LightUp(oper_Transpose, LightUp_6);
  }
  ...
  /*package*/ static void initAxioms() {
    ...
    ITerm.axiom(LightUpSpesification.CorrectPuzzle(LightUpSpesification.AnyPuzzle), BOOLEAN.And(LightUpSpesification.CountBulbsInPuzzle(LightUpSpesification.AnyPuzzle), BOOLEAN.And(LightUpSpesification.CheckAllSightLines(LightUpSpesification.AnyPuzzle), LightUpSpesification.CheckAllSightLines(LightUpSpesification.Transpose(LightUpSpesification.AnyPuzzle)))));
  }
  ...
  public static void main(String[] args) {
    ...
    final ITerm test1 = ITerm.let("test1", LightUpSpesification.mkLightUp(LightUpSpesification.mkLine(LightUpSpesification._B(), LightUpSpesification._1(), LightUpSpesification._W(), LightUpSpesification._B(), LightUpSpesification._W()), LightUpSpesification.mkLine(LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._B(), LightUpSpesification._4(), LightUpSpesification._B()), LightUpSpesification.mkLine(LightUpSpesification._B(), LightUpSpesification._W(), LightUpSpesification._2(), LightUpSpesification._B(), LightUpSpesification._W()), LightUpSpesification.mkLine(LightUpSpesification._2(), LightUpSpesification._B(), LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._W()), LightUpSpesification.mkLine(LightUpSpesification._B(), LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._W(), LightUpSpesification._W())));
